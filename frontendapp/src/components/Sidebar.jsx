...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-white text-gray-800 shadow-lg h-screen"> {/* Added h-screen for full height */}
      <div className="p-6">
        <ul className="space-y-2">
          <li>
            <Link
              to="/resume-upload"
              className={`flex justify-between items-center p-2 text-gray-800 hover:text-[#800080] hover:bg-gray-100 rounded-lg ${isResumeUpload ? 'bg-[#F0CBF0]' : ''}`}
            >
          ...
          <li>
            <Link
              to="/create-job"
              className={`flex justify-between items-center p-2 text-gray-800 hover:text-[#800080] hover:bg-gray-100 rounded-lg ${isCreateJob ? 'bg-[#F0CBF0]' : ''}`}
            >
          ...
          <li>
            <Link
              to="/open-jobs"
              className={`flex justify-between items-center p-2 text-gray-800 hover:text-[#800080] hover:bg-gray-100 rounded-lg ${isOpenJobs ? 'bg-[#F0CBF0]' : ''}`}
            >
          ...
          <li>
            <Link
              ...
              className={`flex justify-between items-center p-2 text-gray-800 hover:text-[#800080] hover:bg-gray-100 rounded-lg ${isUpcomingInterviews ? 'bg-[#F0CBF0]' : ''}`}
            >
          ...
          <li>
            <Link
              to="/reports"
              className={`flex justify-between items-center p-2 text-gray-800 hover:text-[#800080] hover:bg-gray-100 rounded-lg ${isReports ? 'bg-[#F0CBF0]' : ''}`}
            >
